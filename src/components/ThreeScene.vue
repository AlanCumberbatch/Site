...
const networkBox = ref<HTMLElement | null>(null)
...
let networkRenderer: THREE.WebGLRenderer | null = null
let networkScene: THREE.Scene
let networkCamera: THREE.PerspectiveCamera
